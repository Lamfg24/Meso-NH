!     ################################
      MODULE MODI_VER_PREP_MACC_NETCDF_CASE
!     ################################
INTERFACE
      SUBROUTINE VER_PREP_MACC_NETCDF_CASE(PDIAG)
!
REAL, INTENT(OUT)                 :: PDIAG    ! diagnostics computing time
!
END SUBROUTINE VER_PREP_MACC_NETCDF_CASE
END INTERFACE
END MODULE MODI_VER_PREP_MACC_NETCDF_CASE
!     ####################################################################
      SUBROUTINE VER_PREP_MACC_NETCDF_CASE(PDIAG)
!     ####################################################################
!
...
!-------------------------------------------------------------------------------
!
WRITE(ILUOUT0,*) 'Routine VER_PREP_MACC_NETCDF_CASE completed'
!
END SUBROUTINE VER_PREP_MACC_NETCDF_CASE
