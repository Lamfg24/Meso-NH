...
CASE('NH4NO3')      ! Ammonium nitrate
   XKAPPA = 0.67
CASE('DAC_CONT')    ! Averaged continental kappa (Maury)
   XKAPPA = 0.2368
CASE('DAC_MARI')    ! Averaged maritime kappa (Maury)
   XKAPPA = 0.3858
...
CASE('SOA')         ! Secondary organic aerosol (alpha-pinene, beta-pinene)
   XKAPPA = 0.1
CASE('Dust')        ! Dust particles "Hygroscopicity and cloud droplet activation of mineral dust aerosol" K.A. Koehler
   XKAPPA = 0.008
!CASE('BB')          ! Biomass Burning particles "Impact of mixing state and hygroscopicity on CCN activity of biomass burning aerosol in Amazonia" Gacita between 0.05 and 0.13
!   XKAPPA = 0.085
CASE('BC')          ! Black Carbon particles between "Characterization of Size-Resolved Hygroscopicity of Black Carbon-Containing Particle in Urban Environment" Yangzhou Wu 0.3 and 0.4
   XKAPPA = 0.035

CASE('BACKGR')      ! Dacciwa Denjean Background Kappa for DACBL
   XKAPPA = 0.388
CASE('BACKGRBB')    ! Dacciwa Denjean Background Kappa for DACBLBB
   XKAPPA = 0.350
CASE('BACKGRBB2')    ! Dacciwa Denjean Background Kappa for DACBLBB*2
   XKAPPA = 0.318
CASE('BACKGRBBM')    ! Dacciwa Denjean Background Kappa with K_BB=0.04
   XKAPPA = 0.270
CASE('BACKGRBBS')    ! Dacciwa Denjean Background Kappa with K_BB=0.01 full BB
   XKAPPA = 0.226
CASE('BACKGRBBD')    ! Dacciwa Denjean Background Kappa for DACBLBB and dust
   XKAPPA = 0.330
CASE('LOC')         ! Dacciwa Denjean Local Kappa for DACBL without BC
   XKAPPA = 0.315
CASE('LOCBC')       ! Dacciwa Denjean Local Kappa for DACBL with BC and DACBLBB
   XKAPPA = 0.312
CASE('LOCBC2')       ! Dacciwa Denjean Local Kappa for DACBL with BC and DACBLBB
   XKAPPA = 0.309
CASE('BBSC')      ! Dacciwa Denjean Local Kappa for BB
   XKAPPA = 0.114
