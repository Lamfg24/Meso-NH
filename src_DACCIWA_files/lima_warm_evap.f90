...
REAL,    DIMENSION(SIZE(PRHODREF,1),SIZE(PRHODREF,2),SIZE(PRHODREF,3)) :: ZLV !latent heat of vaporization
REAL,SAVE :: XCEVAP                              ! Constants for raindrop evaporation
LOGICAL :: DACCIWA
!!!!!!LAMBERT!!!!
!
!-------------------------------------------------------------------------------
...
!
   ...
   DO JL=1,IEVAP
      ...
      ZCRS(JL) = PCRS(I1(JL),I2(JL),I3(JL)) !!!! LAMBERT !!!!
   END DO
