...
!
  ...
  INTEGER    :: NSV_LIMA_CCN_FREE         ! index of CCN_FREE SV index for lima
  INTEGER    :: NSV_LIMA_IFN_FREE         ! index of IFN_FREE SV index for lima
!
!
END TYPE SV_t
...
YSV%N2D_SNWEND=0
YSV%N2DSNWEQ=0
YSV%NSV_LIMA_CCN_FREE=0
YSV%NSV_LIMA_IFN_FREE=0
