...
!
INTEGER,DIMENSION(JPMODELMAX)::NSV_PYR_A = 0    ! number of volcanic pol.
INTEGER,DIMENSION(JPMODELMAX)::NSV_PYRBEG_A = 0 ! with indices in the range :
INTEGER,DIMENSION(JPMODELMAX)::NSV_PYREND_A = 0 ! NSV_PYRBEG_A...NSV_PYREND_A
!
INTEGER,DIMENSION(JPMODELMAX)::NSV_LV_A = 0    ! number of lava pol.
INTEGER,DIMENSION(JPMODELMAX)::NSV_LVBEG_A = 0 ! with indices in the range :
INTEGER,DIMENSION(JPMODELMAX)::NSV_LVEND_A = 0 ! NSV_LVBEG_A...NSV_LVEND_A
!
...
!
INTEGER :: NSV_PYR   = 0 ! number of volcanic pollutants       
INTEGER :: NSV_PYRBEG = 0! with indices in the range :
INTEGER :: NSV_PYREND = 0! NSV_PYRBEG...NSV_PYREND
!
INTEGER :: NSV_LV    = 0 ! number of lava pollutants       
INTEGER :: NSV_LVBEG = 0 ! with indices in the range :
INTEGER :: NSV_LVEND = 0 ! NSV_LVBEG...NSV_LVEND
!
