...
INTERFACE
!
   SUBROUTINE LIMA ( KKA, KKU, KKL,  HACTCCN,                        &
                     PTSTEP, TPFILE, OCLOSE_OUT,                     &
                     PRHODREF, PEXNREF, PDZZ,                        &
                     PRHODJ, PPABSM, PPABST,                         &
                     NCCN, NIFN, NIMM,                               &
                     PTHM, PTHT, PRT, PSVT, PW_NU, PAEROT,PSOLORG, PMI,      &
                     PTHS, PRS, PSVS,                                &
...
! Concentrations
!
PRINT * , "test lima cold true or not =" , LCOLD
...
CALL LIMA_NUCLEATION_PROCS (PTSTEP, TPFILE, OCLOSE_OUT, PRHODJ,                &
                            ...
                            ZCCT, ZCRT, ZCIT, PAEROT,PSOLORG, PMI, HACTCCN,     &
