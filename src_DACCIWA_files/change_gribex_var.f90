...
!
print*,' calcul douteux'
print*,'ZEXNFLUX_LS(:,:,1:ILU-1) =',MINVAL(ZEXNFLUX_LS(:,:,1:ILU-1)), MAXVAL(ZEXNFLUX_LS(:,:,1:ILU-1))
print*,'ZEXNFLUX_LS(:,:,2:ILU-1) =',MINVAL(ZEXNFLUX_LS(:,:,2:ILU-1)), MAXVAL(ZEXNFLUX_LS(:,:,2:ILU-1))
  ZEXNMASS_LS(:,:,1:ILU-1)=(ZEXNFLUX_LS(:,:,1:ILU-1)-ZEXNFLUX_LS(:,:,2:ILU))            &
                      /(LOG(ZEXNFLUX_LS(:,:,1:ILU-1))-LOG(ZEXNFLUX_LS(:,:,2:ILU)))
print*,'ZEXNMASS_LS(:,:,1:ILU-1)=',MINVAL(ZEXNMASS_LS(:,:,1:ILU-1)), MAXVAL(ZEXNMASS_LS(:,:,1:ILU-1)) 
!
