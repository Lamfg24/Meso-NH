...
!!      Modification    06/2019  (M. Claeys) Add different shapes for ice crystals
!!      Modification    02/2020  (P. Tulet) salt/dust emission for LIMA
!-------------------------------------------------------------------------------
!
!*       0.   DECLARATIONS
!             ------------
...
USE MODD_DYN_n,     ONLY : LHORELAX_SV,LHORELAX_SVC2R2,LHORELAX_SVC1R3,   &
                           ...
                           LHORELAX_SVSNW,LHORELAX_SVLV,LHORELAX_SVPYR    
#ifdef MNH_FOREFIRE
...
ENDIF
IF (CCLOUD == 'LIMA' ) THEN
  CSV(NSV_LIMA_CCN_FREE_A(KMI)  ) = 'CCNFRE'
ENDIF
!
END SUBROUTINE INI_NSV
