...
!***************************************************************
!
TSTATION%LAT              = (/ -21.07960, -21.208611, -21.294333,  -21.2416790 /) 
TSTATION%LON              = (/ 55.38410, 55.571944, 55.627917, 55.7330157 /)
!TSTATION%I                = (/ 25  /) 
!TSTATION%J                = (/ 20 /)
!
!***************************************************************
...
!* station name
!***************************************************************
TSTATION%NAME        = (/ 'MAIDO','OVPF0','GDCOU','VENT0' /)
!***************************************************************
!* station type
!***************************************************************
TSTATION%TYPE        = (/ 'sol     ','sol     ','sol     ','sol     '/)
!
!----------------------------------------------------------------------------
ENDIF
!
