...
INTEGER :: II, ITEST           
!
IF (NVERB==20) print*,'PSULF =',MINVAL(PSULF), MAXVAL(PSULF)
IF (NVERB==20) print*,'ZCSTAVOG =',ZCSTAVOG
IF (NVERB==20) print*,'PTEMP =',MINVAL(PTEMP), MAXVAL(PTEMP)
IF (NVERB==20) print*,'PRH =',MINVAL(PRH), MAXVAL(PRH)
!----------------------------------------------------------------------------
!
...
IF (NVERB==20) print*,'ZSULF1 =',MINVAL(ZSULF), MAXVAL(ZSULF)
!
...
!
IF (NVERB==20) print*,'ZSULF2 =',MINVAL(ZSULF), MAXVAL(ZSULF)
!----------------------------------------------------------------------------
!
...
print*,'PRC rayon critique (nm) = ',PRC
!print*,'PRC rayon critique (nm) = ', MINVAL(PRC), MAXVAL(PRC)

IF (NVERB==20) THEN
  print*,'PRH =',MINVAL(PRH), MAXVAL(PRH)
  print*,'ZCOJA =',MINVAL(ZCOJA), MAXVAL(ZCOJA)
  print*,'ZCOJB=',MINVAL(ZCOJB), MAXVAL(ZCOJB)
  print*,'ZCOJC =',MINVAL(ZCOJC), MAXVAL(ZCOJC)
  print*,'ZCOJD =',MINVAL(ZCOJD), MAXVAL(ZCOJD)
  print*,'ZCOJE =',MINVAL(ZCOJE), MAXVAL(ZCOJE)
  print*,'ZCOJF=',MINVAL(ZCOJF), MAXVAL(ZCOJF)
  print*,'ZCOJG =',MINVAL(ZCOJG), MAXVAL(ZCOJG)
  print*,'ZCOJH =',MINVAL(ZCOJH), MAXVAL(ZCOJH)
  print*,'ZCOJI =',MINVAL(ZCOJI), MAXVAL(ZCOJI)
  print*,'ZCOJJ =',MINVAL(ZCOJJ), MAXVAL(ZCOJJ)
  print*,'ZSULF3 =',MINVAL(ZSULF), MAXVAL(ZSULF)
  print*,'PJNUC =',MINVAL(PJNUC), MAXVAL(PJNUC)
  print*,'ZAL =',MINVAL(ZAL), MAXVAL(ZAL)
  print*,'ZNTOT =',MINVAL(ZNTOT), MAXVAL(ZNTOT)
  print*,'ZRC =',MINVAL(ZRC), MAXVAL(ZRC)
END IF
!
!
RETURN
