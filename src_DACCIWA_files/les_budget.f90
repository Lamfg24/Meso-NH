...
!
  CASE(6,8,9,10,11,12)
    ...
    !PRINT * , 'LES_BUDG_26112'
    CALL LES_BUDGET_ANOMALY(XCURRENT_RRTS,'-',ZANOM) !!!!LAMBERT!!! possible problème ici
    !
    !PRINT * , 'LES_BUDG_2611'
    !* action in WRT budget
...
INTEGER :: IINFO_ll
    ...
    !PRINT * , 'LES_BUD_ANO_2'
    NULLIFY(TZFIELDS_ll)
    !PRINT * , 'LES_BUD_ANO_21'
    CALL ADD3DFIELD_ll(TZFIELDS_ll, ZS)
    !PRINT * , 'LES_BUD_ANO_22'
    !PRINT * , 'IINFO_ll1 = ' , IINFO_ll
    CALL UPDATE_HALO_ll(TZFIELDS_ll,IINFO_ll)
    !PRINT * , 'IINFO_ll2 = ' , IINFO_ll
    !PRINT * , 'LES_BUD_ANO_23'
