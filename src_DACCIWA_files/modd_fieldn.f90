...
!  C. Barthe  03/2019 : add the sea salt flux
!!
!-------------------------------------------------------------------------------
!
!*       0.   DECLARATIONS
...
!  REAL, DIMENSION(:,:,:), POINTER :: XCIT=>NULL()     ! Pristine ice concentration
  ...
  REAL, DIMENSION(:,:), POINTER :: XFLX_SO2=>NULL()    ! 
  REAL, DIMENSION(:,:), POINTER :: XFLXT_SO2=>NULL()
!
END TYPE FIELD_t
...
FIELD_MODEL(KFROM)%XFLX_SO2=>XFLX_SO2
FIELD_MODEL(KFROM)%XFLXT_SO2=>XFLXT_SO2
!
...
XFLX_SO2=>FIELD_MODEL(KTO)%XFLX_SO2
XFLXT_SO2=>FIELD_MODEL(KTO)%XFLXT_SO2
