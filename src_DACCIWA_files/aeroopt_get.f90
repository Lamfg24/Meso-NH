...
!
  ...
  REAL, DIMENSION(SIZE(PSVTA,1),SIZE(PSVTA,2),SIZE(PSVTA,3),NSP+NCARB+NSOA ,2) :: ZMASS         ![kg/m3] mass of aerosol mode
...
!    ENDIF
 ...
 CONTAINS
    ...
    PRINT*,"Vaeurs SSA AER 550 nm:"
    PRINT*,"MIN = ",MINVAL(PPIZA_WVL(:,:,:,3)),"MAX = ",MAXVAL(PPIZA_WVL(:,:,:,3))
