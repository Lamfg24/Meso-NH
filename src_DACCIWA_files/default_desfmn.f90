...
!!                   03/2013 (C. Barthe) add CIBU ; remove LBOUND (not used)
!!                   06/2019 (M. Claeys) use of different shapes for ice crystals
!!                   07/2019 (JP Pinty)  add RDSF
!-------------------------------------------------------------------------------
!
!*       0.    DECLARATIONS
!              ------------
...
USE MODD_PARAM_LIMA, ONLY : LCOLD, LNUCL, LSEDI, LHHONI, LSNOW, LHAIL, LMEYERS,&
                            ...
                            OACTIT=>LACTIT, NMOD_CCN, XCCN_CONC,               &
                            LCCN_HOM, CCCN_MODES,                              &
                            ...
                            LCRYSTAL_SHAPE, NB_CRYSTAL_SHAPE, LHABIT_CHANGE,   &
!++cb++
                            LECRAD_YANG
!--cb--
!
...
NICEOPT        = 3            ! 1: 'Monochromatic', 2: 'Fu-PSRAD', 3: 'Fu-IFS', 4: 'Baran', 
                              ! 5: 'Baran2016', 6: 'Baran2017', 7: 'Yang'
! LSW_ML_E       = .FALSE.
! LLW_ML_E       = .FALSE.
! LPSRAD         = .FALSE.
! 
NRADLP = 1                    ! 0: ERA-15, 1: Zhang and Rossow, 2: Martin (1994) et Woods (2000)
NRADIP = 1                    ! 0: 40 mum, 1: Liou and Ou (1994), 2: Liou and Ou (1994) improved, 3: Sun and Rikus (1999), 4: LIMA
