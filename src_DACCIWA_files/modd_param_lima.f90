...
!!    -------------
!!      Original             ??/??/13
!!      T. Hoarau   04/2019 add CIBU
!!      M. Claeys   04/2019 add ice crystal shapes
!!      JP Pinty    07/2019 add RDSF
!!      P. Tulet    02/2020 add option to couple directly LIMA to salt/dust emission
!!
!-------------------------------------------------------------------------------
!
...
LOGICAL, SAVE :: LCIBU                  ! TRUE to call Collisional Ice Break up
LOGICAL, SAVE :: LRDSF                  ! TRUE to call Rain Drop Shattering by Freezing
LOGICAL, SAVE :: LCRYSTAL_SHAPE         ! TRUE to use different shapes for ice crystals
LOGICAL, SAVE :: LHABIT_CHANGE          ! TRUE to authorize change of habit 
LOGICAL, SAVE :: LECRAD_YANG            ! TRUE to use ECRAD with the Yang model for ice
LOGICAL, SAVE :: LSALT2LIMA             ! TRUE to couple salt emission directly to lima CCN
LOGICAL, SAVE :: LDUST2LIMA             ! TRUE to couple salt emission directly to lima CCN
!
