...
!       Modification 10/09/2019 (C. Barthe) add ice crystal shapes
!-------------------------------------------------------------------------------
!
!*       0.     DECLARATIONS
!               ------------
...
!PW:TODO/bug2?: Same name of variable in a loop!
    ...
    END IF
    !
    ! Pyroclasts variables
    !
    IF (NSV_PYREND>=NSV_PYRBEG) THEN
      TZFIELD%CSTDNAME   = ''
      TZFIELD%CUNITS     = 'ppp'
      TZFIELD%CDIR       = 'XY'
      TZFIELD%NGRID      = 1
