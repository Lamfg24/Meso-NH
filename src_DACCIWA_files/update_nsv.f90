...
!!  Modify (Barthe)   04/2019 : add nsv_sltdep
...
NSV_PYR     = NSV_PYR_A(KMI)
NSV_PYRBEG  = NSV_PYRBEG_A(KMI)
NSV_PYREND  = NSV_PYREND_A(KMI)
NSV_LV      = NSV_LV_A(KMI)
NSV_LVBEG   = NSV_LVBEG_A(KMI)
NSV_LVEND   = NSV_LVEND_A(KMI)
#ifdef MNH_FOREFIRE
NSV_FF      = NSV_FF_A(KMI)
