...
!
INTEGER      :: NMODE_SLT= 5  ! number of sea salt modes (max 5; default = 5)
!
...
!Initial dry number median radius (um) from Ovadnevaite et al., 2014
!REAL,DIMENSION(5)    :: XINIRADIUS_SLT=  (/0.009, 0.021, 0.045, 0.115, 0.415/)
!Initial, standard deviation from  Ovadnevaite et al., 2014
