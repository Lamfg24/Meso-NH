...
REAL_B  :: PPIZA_SLT(KLON,KLEV)    !wvl ssa salt for current wavelength
REAL_B  :: PCGA_SLT(KLON,KLEV)     !wvl assym.fact salt for current wavelength
REAL_B  :: PTAUREL_SLT(KLON,KLEV)  !wvl tau_{wvl}/tau_{550} for current wavelength
LOGICAL           :: OORILAM                 ! flag for SALT
REAL_B  :: PPIZA_ORI(KLON,KLEV)    !wvl ssa orilam for current wavelength
REAL_B  :: PCGA_ORI(KLON,KLEV)     !wvl assym.fact orilam for current wavelength
REAL_B  :: PTAUREL_ORI(KLON,KLEV)  !wvl tau_{wvl}/tau_{550} for current wavelength
!--MODIF_MESONH
