...
REAL,DIMENSION(:),     ALLOCATABLE :: XA_SV_LS_MACC    ! function A in definition of eta
REAL,DIMENSION(:),     ALLOCATABLE :: XB_SV_LS    ! function B in definition of eta
REAL,DIMENSION(:),     ALLOCATABLE :: XB_SV_LS_MACC    ! function B in definition of eta
REAL,DIMENSION(:,:,:), ALLOCATABLE :: XT_SV_LS    ! temperature
REAL,DIMENSION(:,:,:), ALLOCATABLE :: XT_SV_LS_MACC    ! temperature
REAL,DIMENSION(:,:,:,:),ALLOCATABLE:: XQ_SV_LS    ! specific humidity
REAL,DIMENSION(:,:,:,:),ALLOCATABLE:: XQ_SV_LS_MACC    ! specific humidity
...
REAL,DIMENSION(:,:,:,:), ALLOCATABLE :: XSV_LS_MACC ! scalar mixing ratios
