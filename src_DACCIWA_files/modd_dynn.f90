...
!
  ...
  LOGICAL :: LHORELAX_SVLV
  LOGICAL :: LHORELAX_SVPYR
#ifdef MNH_FOREFIRE
...
LOGICAL, POINTER :: LHORELAX_SVLV=>NULL()
LOGICAL, POINTER :: LHORELAX_SVPYR=>NULL()
#ifdef MNH_FOREFIRE
...
LHORELAX_SVLV=>DYN_MODEL(KTO)%LHORELAX_SVLV
LHORELAX_SVPYR=>DYN_MODEL(KTO)%LHORELAX_SVPYR
#ifdef MNH_FOREFIRE
