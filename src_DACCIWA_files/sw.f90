...
REAL_B  :: PPIZA_SLT(KLON,KLEV,NSW)    !wvl dependent ssa salt
REAL_B  :: PCGA_SLT(KLON,KLEV,NSW)     !wvl dependent assym.fact salt
REAL_B  :: PTAUREL_SLT(KLON,KLEV,NSW)  !wvl dependent tau/tau_{550} for salt
LOGICAL :: OORILAM                     ! flag for orilam
REAL_B  :: PPIZA_ORI(KLON,KLEV,NSW)    !wvl dependent orilam  
REAL_B  :: PCGA_ORI(KLON,KLEV,NSW)     !wvl dependent assym.fact orilam
REAL_B  :: PTAUREL_ORI(KLON,KLEV,NSW)  !wvl dependent tau/tau_{550} for orilam
!--MODIF_MESONH
...
DO JNU = INUVS , INUIR-1
   ...
   !++MODIF_MESONH
     CALL SW1S &
           ...
           &,  OSALT,PPIZA_SLT(:,:,JNU) &       ! SSA for this wavelength
           &,  PCGA_SLT(:,:,JNU)   &            ! GCA for this wavelengt
           &,  PTAUREL_SLT(:,:,JNU) &           ! TAUREL for this wavelength
           &,  OORILAM,PPIZA_ORI(:,:,JNU) &     ! SSA for this wavelength
           &,  PCGA_ORI(:,:,JNU)   &            ! GCA for this wavelengt
           &,  PTAUREL_ORI(:,:,JNU) )           ! TAUREL for this wavelength
   !--MODIF_MESONH
