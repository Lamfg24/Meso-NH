...
REAL_B  :: PPIZA_SLT(KLON,KLEV)    !wvl dependent ssa salt
REAL_B  :: PCGA_SLT(KLON,KLEV)     !wvl dependent assym.fact salt
REAL_B  :: PTAUREL_SLT(KLON,KLEV)  !wvl dependent tau/tau_{550} for salt
LOGICAL          :: OORILAM                 ! flag for ORILAM
REAL_B  :: PPIZA_ORI(KLON,KLEV)    !wvl dependent ssa ORILAM
REAL_B  :: PCGA_ORI(KLON,KLEV)     !wvl dependent assym.fact ORILAM
REAL_B  :: PTAUREL_ORI(KLON,KLEV)  !wvl dependent tau/tau_{550} for ORILAM
!--MODIF_MESONH
