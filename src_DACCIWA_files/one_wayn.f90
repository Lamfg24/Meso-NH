...
! Pyroclasts
!
DO JSV=1,NSV_PYR_A(KMI)
  CALL SET_LSFIELD_1WAY_ll(XSVT(:,:,:,JSV-1+NSV_PYRBEG_A(KDAD)),&
       &ZTSVT(:,:,:,JSV-1+NSV_PYRBEG_A(KMI)),KMI)
END DO
!
! Lava    
!
DO JSV=1,NSV_LV_A(KMI)
  CALL SET_LSFIELD_1WAY_ll(XSVT(:,:,:,JSV-1+NSV_LVBEG_A(KDAD)),&
       &ZTSVT(:,:,:,JSV-1+NSV_LVBEG_A(KMI)),KMI)
END DO
