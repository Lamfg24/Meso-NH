...
for i in range(1,5):
    ...
    NCO = MESO_products.NCCN01T.values[0,:,3:-3,3:-3] # mixing ratio for cloud (g/kg)
    NCF = MESO_products.NFREE01T.values[0,:,3:-3,3:-3]
    NCt = NCO + NCF
...
np.savez("BCBackground_XXL_NAERO_aerooff",NAERO)
